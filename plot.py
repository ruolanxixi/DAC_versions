...
x_grid = gridded_data[:, 0].reshape((32, 82))
y_grid = gridded_data[:, 1].reshape((32, 82))
z_grid = gridded_data[:, 2].reshape((32, 82))
print(x_grid)
print(y_grid)
# Plot original data
...
plt.tight_layout()
plt.savefig('interpolation_pr.png')
plt.show()
